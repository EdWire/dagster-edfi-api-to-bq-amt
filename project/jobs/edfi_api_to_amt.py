...
edfi_api_endpoints = [
    ...
    {"endpoint": "/ed-fi/programs", "table_name": "edfi_programs" },
    {"endpoint": "/ed-fi/programs/deletes", "table_name": "edfi_programs_deletes" },
    ...
    {"endpoint": "/ed-fi/studentProgramAssociations", "table_name": "edfi_student_program_associations" },
    {"endpoint": "/ed-fi/studentProgramAssociations/deletes", "table_name": "edfi_student_program_associations_deletes" },
