...
LEFT JOIN {{ ref('stg_edfi_student_education_organization_associations') }} school_ed_org 
...
LEFT JOIN {{ ref('stg_edfi_student_education_organization_associations') }} district_ed_org 
